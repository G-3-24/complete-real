...
--auto that dont work on tpaura


loadstring(game:HttpGet(('https://raw.githubusercontent.com/G-3-24/MAINNNNNNNNNNNNNNNN/main/combined'),true))()--scripts
wait(0.7)
print"Working"
...
Window:Button({
    Text = "TPaura",
    Callback = function()
        loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/G-3-24/G3-complete/main/tp%20aruaeds"))()--tpaura
    end
})
...
Window:Button({
    Text = "Reach",
    Callback = function()   
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/G-3-24/MAINNNNNNNNNNNNNNNN/main/reach'),true))()--reach ui
    end
})
...
Window2:Button({
    Text = "Detector",
    Callback = function()
                loadstring(game:HttpGet(('https://raw.githubusercontent.com/G-3-24/complete-real/main/README.md'),true))()--newadmindetect
    end
})
Window2:Button({
    Text = "Server Hop",
...
Window2:Button({
    Text = "AntiKick",
    Callback = function()
                loadstring(game:HttpGet(('https://raw.githubusercontent.com/veryskilledperson/master/main/autorejions'),true))()--anitkick
    end
})
Window2:Button({
    Text = "Rejoin",
...
Window2:Button({
    Text = "Toxic",
    Callback = function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/G-3-24/MAINNNNNNNNNNNNNNNN/main/toxic'),true))()--toxic
    end
})
